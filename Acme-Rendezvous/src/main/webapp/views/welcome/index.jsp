...
<div class="slider fullscreen">
	...
	<acme:showSlide title_en="${slide.title_en}" title_es="${slide.title_es}" text_en="${slide.text_en}" text_es="${slide.text_es}" pictureUrl="${slide.pictureUrl}" align="${slide.align}" lang="${lang}"/>
</jstl:forEach>
      <%-- <li>
